...
<table width="100%" cellspacing="0" cellpadding="5" border="0" align="center" class="noprint">
  ...
  <tr>
    ...
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=mcs&page=scan" class="noline">Manual Cut Start</a></td>
    </tr>
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=mce&page=scan" class="noline">Manual Cut End</a></td>
    </tr>
     <tr>
