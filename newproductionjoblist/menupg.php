...
function onUserInactivity(){
  location.href = 'index.php?view=vdp&jt=pg';
}
...
<table width="100%" cellspacing="0" cellpadding="5" border="0" align="center" class="noprint">
  ...
  <tr>
    ...
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=pgs&page=scan" class="noline">Precision Grinding Start</a></td>
    </tr>
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=pge&page=scan" class="noline">Precision Grinding End</a></td>
    </tr>
    <tr>
