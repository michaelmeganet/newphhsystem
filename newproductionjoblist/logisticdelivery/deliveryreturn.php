...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr>
    <td width="49%" valign="top">LOGISTIC DELIVERY - DELIVERY RETURN</td>
    <td width="2%">&nbsp;</td>
    <td width="49%" class="mmfont" valign="top">အေထြေထြထုပ္ပိုးမႈဌာန - ျပန္ပါလာေသာပို႔ကုန္</td>
  </tr>
</table>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr>
    <td>
<form name="deliveryreturn" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return deliveryreturn_validator(this)" method="post">
<input type="hidden" name="bid" id="bid" value="<?php echo $branch; ?>" />

<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr> 
    <td width="49%" valign="top">Scan the <strong style="color:#00FF00">Joblist Barcode Job No</strong> or <strong style="color:#00FF00">Enter the Job No manually</strong> to Return Delivery the item.<br />
    ...
    <td width="2%">&nbsp;</td>
    <td width="49%" class="mmfont" valign="top">ျပန္ပါလာေသာပို႔ကုန္ျပန္ပို႔ရန္ <strong style="color:#00FF00">အလုပ္စာရင္းအား scan ဖတ္ပါ</strong> (သို႔မဟုတ္) <strong style="color:#00FF00">အလုပ္နံပါတ္အား ရိုက္ထည့္ပါ။</strong><br />
  ...
  <tr>
	<td colspan="3"><div id="deliveryreturn_data"></div></td>
  </tr>
</table>
</form>
	</td>
...
window.onload = function(){
				  document.forms['deliveryreturn'].elements['jobno'].focus();
				} 
</script>