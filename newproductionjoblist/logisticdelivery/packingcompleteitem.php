...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr>
    <td width="49%" valign="top">PRODUCTION JOBLIST - PACKING/COMPLETE ITEM</td>
    <td width="2%">&nbsp;</td>
    <td width="49%" class="mmfont" valign="top">ကုန္ထုတ္လုပ္မႈအလုပ္စာရင္း - ထုပ္ပိုးျခင္း/ျပီးဆံုးသည့္ပစၥည္း</td>
  </tr>
</table>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr>
    <td>
<form name="packingcomplete" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return jobliststart_validator(this)" method="post">
<input type="hidden" name="bid" id="bid" value="<?php echo $branch; ?>" />

<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr> 
    <td width="49%" valign="top">Scan the <strong style="color:#00FF00">Joblist Barcode Job No</strong> or <strong style="color:#00FF00">Enter the Job No manually</strong> to set item Packing/Complete.<br />
    ...
    <td width="2%">&nbsp;</td>
    <td width="49%" class="mmfont" valign="top">ထုပ္ပိုးျခင္း/ျပီးဆံုးသည့္ပစၥည္း၏ <strong style="color:#00FF00">အလုပ္စာရင္းအား scan ဖတ္ပါ</strong> (သို႔မဟုတ္) <strong style="color:#00FF00">အလုပ္နံပါတ္အား ရိုက္ထည့္ပါ။</strong><br />
	...
	<td>Job No / <font class="mmfont">အလုပ္အမွတ္စဥ္</font> : <input type="text" name="jobno" id="jobno" maxlength="28" style="width:200px" onkeyup="
        if(this.value.charAt(20) == '('){
          if(this.value.length == '28'){
            getPackingCompleteItem(this.value);
          }
        }
        else{
  ...
  <tr>
	<td colspan="3"><div id="packingcompleteitem_data"></div></td>
  </tr>
</table>
</form>
	</td>
...
window.onload = function(){
				  document.forms['packingcomplete'].elements['jobno'].focus();
				} 
</script>