...
function onUserInactivity(){
  location.href = 'index.php?view=vdp&jt=cm';
}
...
<table width="100%" cellspacing="0" cellpadding="5" border="0" align="center" class="noprint">
  ...
  <tr>
    ...
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=cms&page=scan" class="noline">CNC Machining Start</a></td>
    </tr>
    <tr>
      <td id="tdsubtitle"><a href="index.php?view=cme&page=scan" class="noline">CNC Machining End</a></td>
    </tr>
    <tr>
