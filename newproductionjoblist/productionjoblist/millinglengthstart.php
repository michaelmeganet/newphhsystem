...
//cProductionJoblist('millinglengthstart');
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
    <tr>
        <td width="49%" valign="top">PRODUCTION JOBLIST - MILLING LENGTH START - <b><?php echo $pageMode; ?></b></td>
        <td width="2%">&nbsp;</td>
...
<div id='mainArea'>
    <table width="100%" cellspacing="0" cellpadding="2" border="0">
        <tr>
            <td>
                <form name="millinglengthstart" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return jobliststart_validator(this)" method="post">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                        ...
                        <tr>
                            <td colspan="3">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                        <td colspan="2"><div id="millinglengthstart_data" v-html='jobcode_response'>{{jobcode_response}}<!-- Show Bandsaw Cut Start result here, or show Error if can't be started --></div></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3"><input type="reset" name="clear" id="clear" value="Clear" onclick="getStaffID(0);
                                getMachineID(0);
                                getMillingLengthStart(0);
                                document.forms['millinglengthstart'].elements['staffid'].focus()" /></td>
                        </tr>
                        <tr>
                            <td>
